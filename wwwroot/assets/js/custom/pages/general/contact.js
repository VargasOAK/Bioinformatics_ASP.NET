        ...
        init: function() {
            o = document.querySelector("#kt_contact_form"),
                ...
                function(t) {
                    if (L) {
                        var e, o = L.map(t, {
                            center: [34.62359175682251, 135.48960381349258], // Coordinates for Osaka
                        ...
                        L.marker([34.62359175682251, 135.48960381349258], { // Updated marker position to Osaka
                            icon: a
                        }).addTo(i).bindPopup("Oak, Sumiyoshi", { // Updated popup text
                            closeButton: !1
